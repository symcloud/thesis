...
pdf:
	pandoc --template templates/template.latex --standalone --toc --number-sections --biblio sources.bib -V lang=german -V mainlang=german -o symcloud-thesis.pdf $(mds) -f markdown+table_captions+pipe_tables+definition_lists+fenced_code_attributes+fenced_code_blocks
